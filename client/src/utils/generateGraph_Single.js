  ...
  for (let i = 0; i < size; i++) {
    ...
    //   });
      ...
      for (let dist = 2; dist <= i; dist++){
        ...
        switch (true){
          case (size < 5): exp = 10; break;
          case (size < 7): exp = 3; break;
          case (size < 10): exp = 1; break;
          case (size < 15): exp = 0.5; break;
          case (size < 20): exp = 0.3; break;
          case (size < 25): exp = 0.22; break;
          case (size < 30): exp = 0.2; break;
          case (size < 35): exp = 0.17; break;
          case (size < 40): exp = 0.16; break;
          case (size < 45): exp = 0.15; break;
        ...
        if (dist < size * Math.pow(Math.random() * 1, 1/exp) && dist < size * Math.pow(Math.random() * 1, 1/exp)) {
